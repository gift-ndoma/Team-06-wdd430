        ...
        <div className="footer__main">
          ...
          <div className="footer__section footer__section--brand">
            ...
            <p className="footer__description">
              Discover unique handcrafted items made with love by talented artisans from around the world. 
              Every purchase supports independent creators and preserves traditional craftsmanship.
            </p>
          </div>
